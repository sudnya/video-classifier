...
LAYERS="13"
MINI_BATCH_SIZE="16"
LAYER_OUTPUT_REDUCTION_FACTOR="2"
EPOCHS="20"
LEARNING_RATE="0.01"
MOMENTUM="0.99"
RESUME_FROM=""

EXPERIMENT_NAME="benchmark-image-net-$INPUT_WIDTH-width-$INPUT_HEIGHT-height-$INPUT_COLORS-colors-$LAYER_SIZE-layer-size-$LAYERS-layers-$MINI_BATCH_SIZE-mini-batch-$LEARNING_RATE-learning-rate-$MOMENTUM-momentum"
